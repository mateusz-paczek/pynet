...
def normalize_mac_address(mac_address):
	...
	# Splitting MAC address when "-" or ":" is a separator
...
print(normalize_mac_address('123.234.456'))
print(normalize_mac_address('aabb.ccdd.eeff'))
print(normalize_mac_address('a:b:c:d:e:f'))
print(normalize_mac_address('1:2:a:b:3:44'))
print(normalize_mac_address('a-b-c-d-e-f'))
print(normalize_mac_address('1-2-a-b-3-44'))
