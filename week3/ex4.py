...
#define arp_table - list of tuples
arp_table = [('10.220.88.1', '0062.ec29.70fe'),
	('10.220.88.20', 'c89c.1dea.0eb6'),
	('10.220.88.21', '1c6a.7aaf.576c'),
	('10.220.88.28', '5254.aba8.9aea'),
...
#define empty list to store MAC addresses
mac_address_table = []

#loop through arp_table structure and populate mac_address_table list
for entry in arp_table:
#	print (entry[1])
	mac_address_table.append(entry[1])

#loop through mac_address_table
for mac_addr in mac_address_table:
	#split MAC address
	...
	#Reunite MAC with : as a separator
